...
$.dore = function (element, options) {
  ...
  function init() {
    ...
    if (typeof Chart !== "undefined") {
      Chart.defaults.global.defaultFontFamily = "'yekan', sans-serif";
      ...
      if (document.getElementById("visitChartFull")) {
        ...
        var myChart = new Chart(visitChartFull, {
          type: "LineWithShadow",
          data: {
            labels: ["2شنبه", "3شنبه", "4شنبه", "5شنبه", "جمعه", "شنبه", "1شنبه"],
            datasets: [
              {
                label: "Data",
        ...
        tooltips: {
          ...
          custom: function (tooltipModel) {
            if (tooltipModel && tooltipModel.dataPoints) {
              ...
              $textContainer.find(".value").html($.fn.addCommas(yLabel) + " تومن");
      ...
      if (document.getElementById("frequencyChart")) {
        ...
        var myDoughnutChart = new Chart(frequencyChart, {
          ...
          type: "DoughnutWithShadow",
          data: {
            labels: ["اضافه کردن", "ویرایش کردن", "حذف کردن"],
            datasets: [
              {
                label: "",
                borderColor: [themeColor1, themeColor2, themeColor3],
    ...
    if (typeof noUiSlider !== "undefined") {
      if ($("#dashboardPriceRange").length > 0) {
        noUiSlider.create($("#dashboardPriceRange")[0], {
          ...
          format: {
            to: function (value) {
              return $.fn.addCommas(Math.floor(value)) + "تومان";
            },
            from: function (value) {
              return value;
            }
      ...
      if ($("#doubleSlider").length > 0) {
        noUiSlider.create($("#doubleSlider")[0], {
          ...
          format: {
            to: function (value) {
              return $.fn.addCommas(Math.round(value)) + "تومان";
            },
            from: function (value) {
              return value;
            }
